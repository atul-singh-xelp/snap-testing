module.exports={
    candidateSubmityourcvButton:'#root > div > div.JobSeekerHomePage-Container > div > div.HomeBanner > div > div.HomeBanner-InnerBoxHolder > div > div > div > div > div:nth-child(1) > div > div',
    candidateFirstName:'#modal-root > div > div > div.ModalPanel-content > div > div.Auth > div > div.LoginFlow-panelContainer > div > div:nth-child(2) > div:nth-child(1) > div > input',
    candidateLastName: '#modal-root > div > div > div.ModalPanel-content > div > div.Auth > div > div.LoginFlow-panelContainer > div > div:nth-child(2) > div:nth-child(2) > div > input',
    candidateEmail: '#modal-root > div > div > div.ModalPanel-content > div > div.Auth > div > div.LoginFlow-panelContainer > div > div:nth-child(3) > div > input',
    candidatePassword: '#modal-root > div > div > div.ModalPanel-content > div > div.Auth > div > div.LoginFlow-panelContainer > div > div:nth-child(5) > div > input',
    candidatePhoneNo: '#modal-root > div > div > div.ModalPanel-content > div > div.Auth > div > div.LoginFlow-panelContainer > div > div:nth-child(4) > div > input', 
    ...
    recruiterEmail: '#modal-root > div > div > div.ModalPanel-content > div > div.Auth > div > div.LoginFlow-panelContainer > div > div:nth-child(3) > div > input',
    recruiterPhoneNo:'#modal-root > div > div > div.ModalPanel-content > div > div.Auth > div > div.LoginFlow-panelContainer > div > div:nth-child(4) > div > input',
